...
/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:iconSize 64" ~/Library/Preferences/com.apple.finder.plist

# Increase the size of icons other icon views
/usr/libexec/PlistBuddy -c "Set :IconViewSettings:iconSize 80" ~/Library/Preferences/com.apple.finder.plist
